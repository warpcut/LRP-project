...
model = tensorflow.keras.models.Sequential([
    ...
    tensorflow.keras.layers.MaxPooling2D((3, 3), strides=(2,2), padding='same'),
    ...
    tensorflow.keras.layers.Dense(512, activation="relu", name='dense_512'),
    tensorflow.keras.layers.Dropout(0.4),
    tensorflow.keras.layers.Dense(10, activation="softmax", name='dense_out'),
])
'''
model = tensorflow.keras.models.Sequential([
    tensorflow.keras.layers.Conv2D(32, (3, 3), use_bias=False, input_shape=input_shape),
    tensorflow.keras.layers.BatchNormalization(),
    tensorflow.keras.layers.Activation("relu"),
    tensorflow.keras.layers.Conv2D(64, (3, 3), use_bias=False),
    tensorflow.keras.layers.BatchNormalization(),
    tensorflow.keras.layers.Activation("relu"),
    tensorflow.keras.layers.MaxPooling2D((3, 3), strides=(2,2), padding='same'),
    tensorflow.keras.layers.Dropout(0.4),
    ...
    tensorflow.keras.layers.MaxPooling2D((3, 3), strides=(2,2), padding='same'),
    tensorflow.keras.layers.Dropout(0.4),
    tensorflow.keras.layers.Conv2D(128, (3, 3), use_bias=False),
    tensorflow.keras.layers.BatchNormalization(),
    tensorflow.keras.layers.Activation("relu"),
    tensorflow.keras.layers.Conv2D(128, (3, 3), use_bias=False),
    tensorflow.keras.layers.BatchNormalization(),
    ...
    tensorflow.keras.layers.Dropout(0.4),
    tensorflow.keras.layers.Flatten(),
    tensorflow.keras.layers.Dense(512, use_bias=False, name='dense_512'),
    tensorflow.keras.layers.BatchNormalization(),
    tensorflow.keras.layers.Activation("relu"),
    tensorflow.keras.layers.Dropout(0.4),
    tensorflow.keras.layers.Dense(10, use_bias=False, name='dense_out'),
    tensorflow.keras.layers.BatchNormalization(),
...
optimizer = tensorflow.keras.optimizers.Nadam(learning_rate=0.0005)
model.compile(optimizer,loss="categorical_crossentropy",metrics=["accuracy"])
model.summary()

reduce_lr = ReduceLROnPlateau(monitor='val_loss', factor=0.1,
                              patience=8, min_lr=0.001, verbose=1)
mcp_save = ModelCheckpoint("./models/model_weights_80_nadam.h5", save_best_only=True, monitor='val_loss', mode='min')
...
model.save('./models/modelB_80_nadam.h5')
